...
const ResidentCard = ({ resident }) => {
  ...
  return (
    <article className=" shadow-lg shadow-slate-500 z-50">
      <div className="relative border-[3px] border-green-600 rounded-t">
      ...
      <section className="border-[2px] border-green-600 h-[168px] rounded-b">
        <h3 className="text-white font-bold text-lg text-left px-5 ">
          {residentInfo?.name}
        </h3>
        <ul className="py-2">
          <li className="py-1 px-3">
            <span className="text-[12px] text-white/50 px-0">Species</span>
            <span className="text-white text-[13px] pl-12">
              {residentInfo?.species}
            </span>
          </li>
          <li className="py-1 px-3">
            <span className="text-[12px] text-white/50">Origin</span>
            <span className="text-white text-[13px] pl-14">
              {residentInfo?.origin.name}
            </span>
          </li>
          <li className="py-1 px-3">
            <span className="text-[12px] text-white/50">Times appear</span>
            <span className="text-white text-[13px] pl-4">
